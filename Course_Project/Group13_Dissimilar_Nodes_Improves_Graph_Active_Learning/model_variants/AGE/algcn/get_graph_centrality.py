...
def centralissimo(G):
    ...
    #centralities.append(nx.communicability_betweenness_centrality(G))
    #centralities.append(nx.katz_centrality(G))
    #centralities.append(nx.current_flow_betweenness_centrality(G))
    #centralities.append(nx.communicability_betweenness_centrality(G))
